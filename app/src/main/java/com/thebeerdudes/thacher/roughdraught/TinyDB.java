...
public class TinyDB {
    ...
    public ArrayList<Beer> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Beer> objects =  new ArrayList<>();

    	for(String jObjString : objStrings){
            Object value  = gson.fromJson(jObjString,  mClass);
    		objects.add((Beer)value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Beer> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<>();
    	for(Beer obj : objArray){
